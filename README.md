...
4. Running the ETL App ( as mentioned in the email) from Spark (Scala)on the data pushed to HDFS in Step 2.
	Basically the Spark ETL App will write the data in to destination location in to 2 tables. ( table names avg_data_val_all_age_grp and avg_data_val_female)
